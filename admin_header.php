...
<body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light py-lg-0 px-lg-5 wow fadeIn" data-wow-delay="0.1s">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto p-4 p-lg-0">
                    <a href="admin_panel.php" class="nav-item nav-link">Home</a>
    ...
    <div class="admin-banner">
        <div class= "detail">
            ...
            <p>Check your products and orders in a detailed manner.
                You can also check all messages sent to you by your customers. </p>
        </div>
    </div>
    <div class= "line"></div>
